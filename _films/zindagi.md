...
<swiper-container keyboard="true" navigation="true" rewind="true">
  <swiper-slide>{% include figure.liquid loading="eager" path="assets/img/films/zindagi/zindagi10.png" class="img-fluid rounded z-depth-1" zoomable=true %}</swiper-slide>
